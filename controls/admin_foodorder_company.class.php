...
class admin_foodorder_company_controller {
	...
	public function __construct() {
		...
		if(!in_array($_G['userlevel'], array($_G['setting']['userlevel']['superadmin'], $_G['setting']['userlevel']['company']))) {
	...
	public function index_action() {
		...
		if(!submitcheck('submit')) {
			...
			include template('admin_foodorder_company');
		} else {
